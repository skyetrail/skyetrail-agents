...
| --- | --- | --- | --- | --- | --- |
| [`skyetrail`](plugins/skyetrail) | 2.0.0 | Skyetrail house tools for agents. Starts with the Skyetrail plain-English writing style and grows as we share more of our working setup. | 2 | 0 | 0 |
...
| --- | --- | --- | --- |
| [`skyetrail-chat`](plugins/skyetrail/skills/skyetrail-chat/SKILL.md) | [`skyetrail`](plugins/skyetrail) | 1.0.0 | Skyetrail's plain-English style for conversational replies. Use for every chat reply, answer, explanation, or discussion, not only for documents. Enforces no em dashes, plain everyday words, complete sentences, minimal formatting, and no imagery. |
| [`skyetrail-writing`](plugins/skyetrail/skills/skyetrail-writing/SKILL.md) | [`skyetrail`](plugins/skyetrail) | 1.1.0 | Skyetrail's plain-English house writing style. Use whenever writing or editing prose, such as documents, emails, messages, marketing copy, or posts. Enforces no em dashes, plain everyday words, complete sentences, no jargon, and no imagery. |
