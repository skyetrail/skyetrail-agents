...
Return
Return these sections, in this order. Write "none" in any section with nothing to report.
...
5. Noticed but out of scope: anything outside the three focus areas that a person needs to see.
