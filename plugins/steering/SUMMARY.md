...
apply. Experiments measured them across thirteen trials, and every rule here came from a measured
...
- [OUTCOMES.md](./OUTCOMES.md) states all thirteen experiments and what each one settled.
