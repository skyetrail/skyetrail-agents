...
apply. Experiments measured them across fourteen trials, and every rule here came from a measured
...
- [OUTCOMES.md](./OUTCOMES.md) states all fourteen experiments and what each one settled.
